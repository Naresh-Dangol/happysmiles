          ...
          <tr>
            <form action="/admin/navigation-list/vlink/{{$link->id}}/update" method="POST" enctype="multipart/form-data">
              ...
              <td>
                ...
                <input type="text" name="vlink" id="vlink" value="{{$link->vlink}}"  class="form-control" placeholder="Youtube links" />
              </td>
             
              
              <td><textarea name="content" class="form-control" placeholder="video caption">{{$link->content}}</textarea>
              </td>
