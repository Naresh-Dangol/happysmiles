<section class="rev_slider_wrapper" style="background:#f2f2f2;">
    <div id="slider1" class="rev_slider"  data-version="5.0">
        <ul>
            @if(count($sliders) >0)
                @foreach($sliders as $slider)
                    <li data-transition="fade">
                <img src="{{asset('uploads/photo_gallery/'.$slider->file)}}"  alt="" width="1920" height="683" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            @endif
            <!-- <li data-transition="fade">
                <img src="http://themedesigner.in/demo/Helping-Hands/images/featured-slider.jpg"  alt="" width="1920" height="683" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
            ...
            <li data-transition="fade">
                <img src="images/slider/banner-2.jpg"  alt="" width="1920" height="683" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
